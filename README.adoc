...
* GWT-2.8.0 users: Disable "safe writes" `Settings -> Appearance & Behavior -> System Settings -> Use "safe write"` until https://github.com/gwtproject/gwt/issues/9310 is resolved
